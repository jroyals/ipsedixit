...
/**
 * Finds a {@link net.sf.ipsedixit.core.fieldhandler.FieldHandler} implementation for a given
...
public interface FieldHandlerFinder {
     ...
     * @return a {@link net.sf.ipsedixit.core.fieldhandler.FieldHandler} that can handle the
     * {@link net.sf.ipsedixit.core.MutableField}
     */
