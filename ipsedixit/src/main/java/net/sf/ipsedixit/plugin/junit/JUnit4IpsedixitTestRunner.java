 ...
 * <p>Configuration is provided by the {@link net.sf.ipsedixit.annotation.AnnotationConfiguration} class.</p>
 */
public class JUnit4IpsedixitTestRunner extends JUnit4ClassRunner implements ConfigurationProvider {
     ...
     * @param configuration the {@link net.sf.ipsedixit.configuration.Configuration} to use when getting the
     * DataPopulator.
     * @return the DataPopulator to use.
     */
    protected DataPopulator getDefaultDataPopulator(Configuration configuration) {
        return DataPopulatorFactory.INSTANCE.createDataPopulator(configuration);
    }
    ...
    /**
     * Override only if you want to use a different Configuration mechanism.  By default this method returns a {@link
