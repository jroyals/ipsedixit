 ...
 *
 * @see net.sf.ipsedixit.annotation.AnnotationConfiguration
 */
...
public @interface Ipsedixit {
    ...
    /**
     * Return the types of any additional {@link net.sf.ipsedixit.core.fieldhandler.FieldHandler}'s to use.
     * These will run <i>after</i> the standard Ipsedixit FieldHandler's. Specifying a value here will
     * override the default post handlers.
     */
    Class<? extends FieldHandler>[] postHandlers() default {};

    /**
     * Return the types of any additional {@link net.sf.ipsedixit.core.fieldhandler.FieldHandler}'s to use.
     * These will run <i>before</i> the standard Ipsedixit FieldHandler's.
     */
    Class<? extends FieldHandler>[] preHandlers() default {};
}
