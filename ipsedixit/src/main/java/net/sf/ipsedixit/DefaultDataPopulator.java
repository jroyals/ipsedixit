...
/**
 * Default implementation of DataProvider that uses an {@link net.sf.ipsedixit.core.FieldHandlerFinder} to locate the
 * most appropriate FieldHandler, and an {@link net.sf.ipsedixit.core.ObjectAnalyser} which will parse the object to
 * populate and look for its {@link net.sf.ipsedixit.core.MutableField}'s.
 */
public class DefaultDataPopulator implements DataPopulator {
     ...
     *
     * @param fieldHandlerFinder a FieldHandlerFinder to locate the most appropriate field handler.
     * @param objectAnalyser an ObjectAnalyser to determine which fields are mutable and which ones are not.  Mutable
     * fields will always have data populated by Ipsedixit.
     */
